...
share_dir_path = '\\\\192.168.60.72\\Test\\TestData(72)\\166023015\\data_spp_replay'
...
def run(dir_path, in_file_type="kml"):
	...
	for case_name in case_names:
		...
		for file in files:
			...
			# 					error_info_to_json['cases'][case_name] = dict()
			#
			# 				error_info_to_json['cases'][case_nam
				# 	try:
				# 		if_pass(duration_info, out_file_list, file, case_name)
				# 	except:
				# 		print("Failed excluding max error")
